...
runseq:
	srun --partition=cpar perf stat -r 3 -M cpi -e cache-misses,instructions,cycles ./MDseq.exe < inputdata.txt

runpar:
	srun --partition=cpar perf stat -r 3 -M cpi -e cache-misses,instructions,cycles ./MDpar.exe < inputdata.txt
